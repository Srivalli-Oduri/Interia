...
function getquote(quote) {
    window.open(`/book?name=${document.getElementById(quote).textContent.split(" ").join("+")}`, '_self');
}
...
window.addEventListener('load', () => {
    ...
    if (topic == 'living-room') {
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-living-room.jpg')";
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/living${i}.jpg`;
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-kitchen.jpg')";
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/kitchen${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`;
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-master-bedroom.jpg')";
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/master-bedroom${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`;
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-dining-room.jpg')";
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/dining-room${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`;
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-kids-bedroom.jpg')";
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/kids-bedroom${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`;
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-bathroom.jpg')";
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/bathroom${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`;
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-wardrobe.jpg')";
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/wardrobe${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`;
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
        ...
        document.getElementById('bnr').style['background-image'] = "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url('/static/images/show-background-pooja-room.jpg')";
        ...
        const prilist = ["", "228,866", "254,723", "347,399", "194,164", "300,397", "311,533", "81,221", "121,244", "227,555", "181,631"];
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `/static/images/pooja-room${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`;
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
